...
This project is my attempt to produce a useful organisation tool (though atm it has only been partially developed). The project contains a useful suite of time-management tools such as to-do lists, schedules and journals that are interconnected with analytics that produce useful information such as statistics on personal information, whilst suggesting new activities and improvements to schedule. Potential areas for growth include the application for support of multiple users (which would allow for collective data to support individual self-improvement) and the usage of AI for the optimization of daily schedules.  I think that this data analytical tool for self-improvement aims to deliver real value to people with the same very peculiar desires that I have i.e. to see personal statistics laid out in front of me.
